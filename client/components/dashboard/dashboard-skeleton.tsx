        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-[repeat(auto-fit,minmax(240px,1fr))]">
                {Array.from({ length: 4 }).map((_, i) => (
                    <div
                        key={i}
                        className="flex flex-col gap-4 rounded-xl border border-border bg-card p-6 shadow-lg shadow-primary"
                    >
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                {Array.from({ length: 2 }).map((_, i) => (
                    <div
                        key={i}
                        className="rounded-xl border border-border bg-card p-6 shadow-lg shadow-primary"
                    >
            ...
            <div className="rounded-xl border border-border bg-card p-6 shadow-lg shadow-primary">
                <div className="flex animate-pulse items-center justify-between">
