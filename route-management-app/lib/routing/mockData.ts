import { Stop, SuggestedRoute, WeeklyVehicleAvailability } from './types';
...
export const MOCK_SUGGESTED_ROUTES: SuggestedRoute[] = [
  {
    id: 'sr-001',
    name: 'Route Alpha – Fastest',
    stops: [MANILA_LOCATIONS[0], MANILA_LOCATIONS[3], MANILA_LOCATIONS[2], MANILA_LOCATIONS[4]],
    totalDistanceKm: 13.2,
    totalDurationMinutes: 41,
    vehicleType: 'car',
    optimizationType: 'fastest',
    trafficAware: false,
    description: 'Optimized for travel time via EDSA. 4 stops.',
  },
  {
    id: 'sr-002',
    name: 'Route Beta – Shortest Distance',
    stops: [MANILA_LOCATIONS[0], MANILA_LOCATIONS[1], MANILA_LOCATIONS[3], MANILA_LOCATIONS[4]],
    totalDistanceKm: 10.4,
    totalDurationMinutes: 52,
    vehicleType: 'car',
    optimizationType: 'shortest',
    trafficAware: false,
    description: 'Minimizes total kilometers driven. 4 stops.',
  },
  {
    id: 'sr-003',
    name: 'Route Gamma – Motorcycle Express',
    stops: [MANILA_LOCATIONS[0], MANILA_LOCATIONS[5], MANILA_LOCATIONS[4]],
    totalDistanceKm: 4.8,
    totalDurationMinutes: 18,
    vehicleType: 'motorcycle',
    optimizationType: 'fastest',
    trafficAware: false,
    description: 'Compact 2-stop run suited for a motorcycle.',
  },
  {
    id: 'sr-004',
    name: 'Route Delta – Motorcycle Single',
    stops: [MANILA_LOCATIONS[0], MANILA_LOCATIONS[4]],
    totalDistanceKm: 2.1,
    totalDurationMinutes: 9,
    vehicleType: 'motorcycle',
    optimizationType: 'fastest',
    trafficAware: false,
    description: 'Single-stop express delivery.',
  },
];
